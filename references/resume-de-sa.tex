...
\noindent\textit{Data Scientist with 4+ years of experience designing data systems and driving actionable insight generation. Supporting GenAI-native data platform development at an enterprise AI startup.}
...
\textbf{Core Competencies:} Data Engineering, ETL, Distributed Computing, Cloud Data Infrastructure, Machine Learning, NLP, Agentic Systems, Retrieval-Augmented Generation (RAG), LLM Evaluation \& Deployment, Statistical Modeling \\
\textbf{Languages and Frameworks:} Python, SQL, protobuf, Pydantic, LiteLLM, PySpark, Polars, Scikit-learn, PyTorch, Object-Relational Modeling \\
\textbf{Platforms \& Tools:} Databricks (FS, Notebooks, Catalog, Jobs), Apache Iceberg, Temporal.io, DuckDB, SQL Server, Docker, Microsoft Azure (ADF, ADLS), AWS, GCP, Tableau, Git, CICD, RESTful Web Services
