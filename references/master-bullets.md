...
**Company Description:** GenAI-native enterprise data-platform turning complex, multimodal data into explainable, actionable intelligence.

### Available Bullets:

1. **LLM Evaluation**
   > Automated end-to-end evaluation frameworks for LLM-based information composition systems, implementing automated benchmarking pipelines with LLM-as-a-judge validation across multiple domain-specific datasets, enabling systematic quality measurement and model performance tracking.

2. **Multi-cloud Ingestion (Standard)**
   > Designed and delivered an end-to-end ingestion framework enabling integration of multi-cloud object storage (S3, Azure Blob, GCS) in product, supporting incremental loads and Apache Iceberg for large-scale data management.
...
2. **Data Pipelines + $80K** (combined variant)
   > Engineered and deployed data pipelines using ADF, Databricks, ADLS, and SQL to integrate 5 diverse sources, collaborating with 8 cross-functional teams to automate emission reporting, achieving 97.85% reduction in turnaround and $80,000 in annual savings.
...
5. **End-to-end Solution ($80K)**
   > Integrated an end-to-end solution for a data source, achieving annual savings of $80,000 in operational costs.

6. **C-Suite Presentation**
...
Select 3 most relevant projects per resume.
...
2. **Deepfake Detection - IEEE Published** (Published Feb 2024)
   - **Shows:** GANs, adversarial training, computer vision, publication record
...
4. **Orcasound / Underwater Acoustic Monitoring** (Apr 2025 – Jun 2025)
...
5. **FeedForward - Databricks Hackathon 1st Place** (Nov 2024)
   - **Shows:** Databricks, Spark, MLflow, Unity Catalog, social impact
...
6. **AGTT - Automated Guitar Tablature Transcription** (Jan 2021 – Apr 2021)
...
```
Core Competencies: NLP, Agentic Systems, Computer Vision, Distributed Computing, Machine Learning, Data Engineering, ETL, Statistical Modeling, Data Warehousing, Cloud Data Infrastructure, Data Visualization
Languages and Frameworks: Python, SQL, BAML, Polars, PySpark, mQuery, Scikit-learn, TensorFlow, PyTorch
Platforms & Tools: Temporal.io, Databricks, DuckDB, Docker, Apache Iceberg, Huggingface Transformers, Microsoft Azure (ADF, ADLS), Tableau, QlikSense, Git, CICD, RESTful Web Services
```

### DE/Solution Architect Focus
```
Core Competencies: Data Engineering, ETL, Distributed Computing, Natural Language Processing, Agentic AI Systems, Retrieval-Augmented Generation (RAG), Machine Learning, Cloud Data Infrastructure, Statistical Modeling
Languages and Frameworks: Python, SQL, PySpark, MapReduce, Scikit-learn, PyTorch, Object-Relational Modeling
Platforms & Tools: Databricks (FS, Notebooks, Catalog, Jobs), DuckDB, Apache Iceberg, Temporal.io, SQL Server, Docker, Microsoft Azure (ADF, ADLS), AWS, GCP, Tableau, Git, CICD
```
...
1. **Default/DS:**
   > Data Scientist with 4+ years of experience designing data systems and driving actionable insights. Currently contributing to an agentic data platform start-up while pursuing an MS in Data Science at the University of Washington.

2. **GenAI Focus:**
   > Data Scientist with 4+ years of experience building ML systems and data pipelines. Currently developing GenAI capabilities at an agentic data platform startup while pursuing an MS in Data Science at the University of Washington.

3. **DE Focus:**
   > Data Scientist with 4+ years of experience designing data systems, and driving actionable insight generation. Supporting GenAI-native data platform development while pursuing an MS in Data Science at the University of Washington.
...
% 2. Data Pipelines + $80K (combined variant)
\item \textbf{Engineered and deployed data pipelines} using ADF, Databricks, ADLS, and SQL to integrate 5 diverse sources, collaborating with 8 cross-functional teams to automate emission reporting, achieving \textbf{97.85\% reduction} in turnaround and \textbf{\$80,000 in annual savings}.
...
% 5. FeedForward (Databricks Hackathon)
\subsection{FeedForward: Global Malnutrition Monitoring System (Databricks$\times$UW Hackathon - 1st Place) \hfill \textit{Nov 2024}}
Built end-to-end data platform on Databricks with ETL using Spark and Databricks Jobs. Developed ML forecasting models with MLflow serving 150+ countries for risk prediction, utilized Unity Catalog for data governance and RBAC.
